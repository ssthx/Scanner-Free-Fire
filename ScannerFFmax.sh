...
check_root_status() {
  ...
  if [ -n "$magisk" ]; then
    ...
    echo -e "${GREEN}[Root]Root não econtrado (rastro de shizuko data 12/09/2024)${RESET}" | tee -a "$LOG_FILE"
  fi
  echo ""
}
...
check_shader_file() {
  ...
  shader_dir="/sdcard/Android/data/com.dts.freefiremax/files/contentcache/Optional/android/gameassetbundles/"
...
check_obb_files() {
  ...
  obb_files=$(adb shell "find /sdcard/Android/obb/com.dts.freefiremax/")
...
check_latest_mreplay_file() {
  ...
  dir="/sdcard/Android/data/com.dts.freefiremax/files/MReplays"
...
check_optionalavatarres() {
  ...
  dir="/sdcard/Android/data/com.dts.freefiremax/files/optionalavatarres"
...
check_android_folder_modification() {
  ...
  dir="/sdcard/Android/data/com.dts.freefiremax/files/contentcache/Optional/android"
  stat_out=$(adb shell "stat $dir" 2>/dev/null)
...
check_metadata() {
  ...
  metadata_dir="/sdcard/Android/data/com.dts.freefiremax/files/metadata"
...
check_recent_file_changes() {
  local pasta_alvo="/caminho/para/sua/pasta"  # Altere para o caminho desejado
